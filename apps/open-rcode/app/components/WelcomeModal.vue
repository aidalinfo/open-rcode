      ...
      <div class="space-y-6">
        ...
        <div class="space-y-4">
          <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
            ...
            <div class="space-y-1">
              <h4 class="font-medium text-gray-900 dark:text-white">Configure AI Provider</h4>
          ...
          <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
            ...
            <div class="space-y-1">
              <h4 class="font-medium text-gray-900 dark:text-white">Connect GitHub Repositories</h4>
              <p class="text-sm text-gray-600 dark:text-gray-300">
          ...
          <div class="flex items-start gap-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
            ...
            <div class="space-y-1">
              <h4 class="font-medium text-gray-900 dark:text-white">Create Your First Environment</h4>
              <p class="text-sm text-gray-600 dark:text-gray-300">
